(function () {
    ...
    ***************************************************************************** */
    ...
    class NHentai extends Rule {
        provideExtensionInfo() {
            let site = new Extension("nhentai", "nhentai", 2 /* MediaType.Picture */);
        ...
        requestItemList(url, page) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                let response = yield this.client.request({ url: api, method: "GET", });
