(function () {
    ...
    ***************************************************************************** */
    ...
    class FreeComputerBooks extends Rule {
        provideExtensionInfo() {
            let site = new Extension('freecomputerbooks', 'FreeComputerBooks', 1 /* MediaType.Article */);
            ...
            site.channel = new Channel(0 /* ChannelType.List */, "Category", "category");
            site.lang = "en";
...
`;
        ...
        requestItemList(url, page) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                let htmlResponse = yield this.client.request({ url: categoryApi, method: "GET", });
