(function () {
    ...
    ***************************************************************************** */
    ...
    class ChinaFactCheck extends Rule {
        provideExtensionInfo() {
            let site = new Extension("chinafactcheck", "国际新闻事实核查", 1 /* MediaType.Article */);
        ...
        parseArticleNodes(articleNodes) {
            ...
            articleNodes.each((index, element) => {
                ...
                let id = ((_a = link.match(/chinafactcheck\.com\/\?p=(\d+)/)) === null || _a === void 0 ? void 0 : _a[1]) || "";
