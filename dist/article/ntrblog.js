(function () {
    ...
    ***************************************************************************** */
    ...
    class NtrBlog extends Rule {
        provideExtensionInfo() {
            let site = new Extension("ntrblog", "NTR BLOG(寝取られブログ)", 1 /* MediaType.Article */);
        ...
        requestItemList(url, page) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                articleNodes.each((index, element) => {
                    ...
                    let id = ((_a = link.match(/ntrblog\.com\/archives\/(\d+)\.html/)) === null || _a === void 0 ? void 0 : _a[1]) || "";
                ...
                let lastPageNum = parseInt(((_a = lastPage.match(/ntrblog\.com\/\?p=(\d+)/)) === null || _a === void 0 ? void 0 : _a[1]) || "0");
