(function () {
    ...
    ***************************************************************************** */
    ...
    class Uuubqq extends Rule {
        provideExtensionInfo() {
            let site = new Extension("uuubqq", "顶点小说网", 5 /* MediaType.Novel */);
        ...
        requestItemMedia(url, id) {
            return __awaiter(this, void 0, void 0, function* () {
                var _a;
                let response = yield ((_a = this.client) === null || _a === void 0 ? void 0 : _a.request({ url: url, method: "GET", responseCharset: "gb2312", }));
                let $nodes = $(response.body);
