(function () {
    ...
    ***************************************************************************** */
    ...
    const bilinovel_decryption_table = {
        "\ue000": "\u72fc",
        "\ue001": "\u8845",
        "\ue002": "\u653f",
        "\ue003": "\u987a",
    ...
    class BiliWenku extends Rule {
        constructor() {
            super(...arguments);
            this.chinese_punctuation = "，。！？、；：“”‘’（）《》〈〉【】『』〖〗…—～＋－＝×÷·—‘’“”『』【】（）《》〈〉「」『』〖〗〘〙〚〛〚〛〘〙〖〗〘〙〚〛〘〙〖〗〘〙";
        }
        // pc website : https://www.linovelib.com
        provideExtensionInfo() {
            let site = new Extension("biliwenku", "哔哩文库", 5 /* MediaType.Novel */);
        ...
        searchItemList(keyword, url, page) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                var htmlResponse = yield ((_a = this.client) === null || _a === void 0 ? void 0 : _a.request(requestOption));
                var html = htmlResponse.body;
                let $nodes = $(html);
                // filter metaNodes
                let metas = [];
                ...
                let metaTitle = ((_b = metas.find(meta => meta.property === "og:novel:book_name")) === null || _b === void 0 ? void 0 : _b.content) || "";
                // jump to novel detail page if meta is not empty
                if (metaTitle && metaTitle.length > 0) {
                    let title = metaTitle;
                    let cover = ((_c = metas.find(meta => meta.property === "og:image")) === null || _c === void 0 ? void 0 : _c.content) || "";
                    let description = ((_d = metas.find(meta => meta.property === "og:description")) === null || _d === void 0 ? void 0 : _d.content) || "";
                    let author = ((_e = metas.find(meta => meta.property === "og:novel:author")) === null || _e === void 0 ? void 0 : _e.content) || "";
                    let category = ((_f = metas.find(meta => meta.property === "og:novel:category")) === null || _f === void 0 ? void 0 : _f.content) || "";
                    let status = ((_g = metas.find(meta => meta.property === "og:novel:status")) === null || _g === void 0 ? void 0 : _g.content) || "";
                    let link = ((_h = metas.find(meta => meta.property === "og:url")) === null || _h === void 0 ? void 0 : _h.content) || "";
                    let pattern = new RegExp('/novel/(.*?).html$', 'i');
                    let id = (_j = pattern.exec(link)) === null || _j === void 0 ? void 0 : _j[1];
        ...
        requestItemChapter(url, id) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                var catalog = this.site.baseUrl + "/novel/{id}/catalog".replace("{id}", id !== null && id !== void 0 ? id : "");
                var htmlResponse = yield ((_a = this.client) === null || _a === void 0 ? void 0 : _a.request({
                ...
                let title = ((_b = metas.find(meta => meta.property === "og:title")) === null || _b === void 0 ? void 0 : _b.content) || "";
                let cover = ((_c = metas.find(meta => meta.property === "og:image")) === null || _c === void 0 ? void 0 : _c.content) || "";
                let description = ((_d = metas.find(meta => meta.property === "og:description")) === null || _d === void 0 ? void 0 : _d.content) || "";
                let author = ((_e = metas.find(meta => meta.property === "og:novel:author")) === null || _e === void 0 ? void 0 : _e.content) || "";
                let category = ((_f = metas.find(meta => meta.property === "og:novel:category")) === null || _f === void 0 ? void 0 : _f.content) || "";
                let status = ((_g = metas.find(meta => meta.property === "og:novel:status")) === null || _g === void 0 ? void 0 : _g.content) || "";
                ((_h = metas.find(meta => meta.property === "og:url")) === null || _h === void 0 ? void 0 : _h.content) || "";
                ...
                volumes.each((_index, element) => {
                    ...
                    let tempVolume = new ItemVolume(volumeTitle, []);
        ...
        requestChapterContent(url) {
            return __awaiter(this, void 0, void 0, function* () {
                var _a;
                return (_a = this.client) === null || _a === void 0 ? void 0 : _a.request({
                    url: url, method: "GET",
                    headers: [
        ...
        _getShuffleParams(chapterlog, chapterId) {
            return __awaiter(this, void 0, void 0, function* () {
                try {
        ...
        requestItemMedia3(url, id) {
            return __awaiter(this, void 0, void 0, function* () {
                var content = "";
                var requestUrl = url;
                var title = "";
                var chapterlogUrl = "https://www.bilinovel.com/themes/zhmb/js/chapterlog.js";
                this.cachedFixedLength;
                while (true) {
                    let html = yield this.requestChapterContent(requestUrl);
                    let $nodes = $(html);
                    var nextUrlId = "";
                    var lastPEncrypted = false;
                    var pShuffled = false;
                    $nodes.each((index, element) => {
                    ...
                    if (pShuffled) {
                        var shuffleParams = yield this._getShuffleParams(chapterlogUrl, id);
